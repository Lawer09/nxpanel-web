export default {
  ...
  'menu.common-report.project': '项目报表',
  'menu.report': '数据报表',
  ...
  'menu.report.user-report-admin': '用户上报报表',
  'menu.report.report-log': '上报日志',
  'menu.report.report-log.user-realtime': '用户上报实时数据',
  'menu.report.report-log.node-realtime': '节点上报实时数据',
  'menu.report-log': '上报日志',
  'menu.report-log.user-realtime': '用户上报实时数据',
  'menu.report-log.node-realtime': '节点上报实时数据',
  'menu.report.node-report-admin': '节点上报报表',
  'menu.report.node-main-report': '节点主报表',
  'menu.report.node-subtable-report': '节点子表校对',
  'menu.report.project': '项目报表',
