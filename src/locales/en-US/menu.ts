export default {
  ...
  'menu.traffic-platform': 'Traffic Proxy',
  'menu.traffic-platform.platforms': 'Platforms',
  'menu.traffic-platform.accounts': 'Accounts',
  'menu.traffic-platform.hourly': 'Hourly Usage',
  'menu.traffic-platform.daily': 'Daily Usage',
  'menu.traffic-platform.monthly': 'Monthly Usage',
  'menu.traffic-platform.trend': 'Trend',
  'menu.traffic-platform.ranking': 'Ranking',
  'menu.traffic-platform.sync-jobs': 'Sync Jobs',
