...
const METRIC_OPTIONS = [
  ...
  },
  {
    label: 'DAU 用户',
    value: 'dauUsers',
    column: { title: 'DAU 用户', dataIndex: 'dauUsers', width: 110 },
    formatter: (v: number) => fmtInt(v),
  },
  {
    label: '广告收入',
  ...
  },
  {
    label: '广告花费',
    value: 'adSpendCost',
    column: { title: '广告花费', dataIndex: 'adSpendCost', width: 110, render: fmtCurrency },
    formatter: (v: number) => fmtCurrency(v),
  },
  {
    label: '花费 CPI',
    value: 'adSpendCpi',
    column: { title: '花费 CPI', dataIndex: 'adSpendCpi', width: 100, render: fmtCurrency },
    formatter: (v: number) => fmtCurrency(v),
  },
  {
    label: '花费 CPC',
    value: 'adSpendCpc',
    column: { title: '花费 CPC', dataIndex: 'adSpendCpc', width: 100, render: fmtCurrency },
    formatter: (v: number) => fmtCurrency(v),
  },
  {
    label: '花费 CPM',
    value: 'adSpendCpm',
    column: { title: '花费 CPM', dataIndex: 'adSpendCpm', width: 100, render: fmtCurrency },
    formatter: (v: number) => fmtCurrency(v),
  },
  {
    label: '流量使用量(MB)',
  ...
  },
  {
    label: '流量成本',
    value: 'trafficCost',
    column: { title: '流量成本', dataIndex: 'trafficCost', width: 110, render: fmtCurrency },
    formatter: (v: number) => fmtCurrency(v),
  },
  {
    label: '利润',
